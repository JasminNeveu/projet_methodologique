...
\begin{figure}[h]
  ...
  \caption{Fonction de répartition des \textit{p-valeur} obenutes par tests de significativité du 2eme coefficient obtenu par une regression Lasso. La fonction de répartition à été calculées à partir de $M = 2000$ simulations.}
